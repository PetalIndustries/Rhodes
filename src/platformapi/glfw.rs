use glfw::{WindowHint, WindowMode, Action, MouseButton, Modifiers, Key};
use glfw::{ffi::glfwTerminate, Glfw, PWindow, Error, Window};
use crate::{core::primitives::color::Color, platformapi::PlatformAPI};
...
fn key_callback(window: &mut Window, key: Key, scancode: i32, action: Action, _: Modifiers) {
}
